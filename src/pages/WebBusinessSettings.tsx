...
export default function WebBusinessSettings() {
  ...
  return <div className="font-web space-y-6">
    <div><div className="flex items-center gap-2 text-sm text-muted-foreground"><Store className="h-4 w-4" /> Website operations</div><PageTitle className="mt-1">Store & business hours</PageTitle><p className="mt-1 text-muted-foreground">Control the public store status and synchronize weekly hours with Google Business Profile.</p></div>
