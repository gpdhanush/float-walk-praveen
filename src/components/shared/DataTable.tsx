...
export function DataTable<T extends Record<string, any>>({ data, columns, searchKeys = [], actions, exportFileName, filterKey, filterOptions = [], pageSizeOptions = [10, 25, 50], loading = false, defaultSortKey }: DataTableProps<T>) {
  const id = useId();
