  ...
  persist(
    (set, get) => ({
      ...
      updateSettings: async (settings) => {
        try {
          console.log('[settingsStore] updateSettings called with logoUrl length:', settings.logoUrl?.length || 0);
          ...
          console.log('[settingsStore] updateProfile response, logoUrl length:', data.logoUrl?.length || 0);
          ...
          console.log('[settingsStore] State updated with logoUrl length:', get().logoUrl?.length || 0);
