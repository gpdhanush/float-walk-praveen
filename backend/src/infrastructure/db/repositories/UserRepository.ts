...
export class UserRepository implements IUserRepository {
  ...
  async update(id: string, data: Partial<User>): Promise<User | null> {
    ...
    console.log(
      "[UserRepository] logoUrl size in update:",
      data.logoUrl
    ...
    try {
      ...
      console.log(
        "[UserRepository] Update successful, affected rows:",
    ...
    console.log(
      "[UserRepository] Fetched updated user, logoUrl length:",
      updated?.logoUrl?.length || 0,
    );
    return updated;
  }
